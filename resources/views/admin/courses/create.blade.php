...
Course add for front page </small>&nbsp;<a href="/courses">Course View</a>
</h1>
</div><!-- /.page-header -->
<div class="row">
<div class="col-xs-12">
...
<form class="form-horizontal" role="form" action="/courses" method="POST" enctype="multipart/form-data">
	{{csrf_field()}}
...
<div class="form-group">
	...
	<div class="col-sm-10">
		...
		<span class="help-inline col-xs-12 col-sm-7">
			<span class="middle">image size 1280 * 600</span></span>
...
<div class="form-group">
	...
	<div class="col-sm-10">
	<input type="text" id="form-field-2" placeholder="Course Name example : Computer" class="col-xs-10 col-sm-5" class="form-control" name="course_name" required="" />
	</div>
</div>
<div class="form-group">
	<label class="col-sm-2 control-label no-padding-right" for="form-field-2">Course Title :</label>
	<div class="col-sm-10">
		<input type="text" id="form-field-2" placeholder="Course Title example : Diploma in Computer Engineering" class="col-xs-10 col-sm-5" class="form-control" name="course_title" required="" />
	</div>
</div>
<div class="form-group">
