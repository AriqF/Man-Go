...
Education Update for front page </small>&nbsp;<a href="/educations">Education View</a>
</h1>
</div><!-- /.page-header -->
<div class="row">
<div class="col-xs-12">
...
{{Form::open(['url'=>'/educations/'.$data->id ,'method'=>'PATCH','class'=>'form-horizontal','enctype'=>'multipart/form-data'])}}
...
<div class="form-group">
	...
	<div class="col-sm-10">
<textarea name="short_description" placeholder="short description minimum 500 character" required="" class="form-control">{{$data->short_description}}</textarea>
	</div>
</div>
<div class="form-group">
