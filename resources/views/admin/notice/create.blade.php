...
Notice add for front page </small>&nbsp;<a href="/notices">Notice View</a>
</h1>
</div><!-- /.page-header -->
<div class="row">
<div class="col-xs-12">
...
<form class="form-horizontal" role="form" action="/notices" method="POST" enctype="multipart/form-data">
	{{csrf_field()}}
