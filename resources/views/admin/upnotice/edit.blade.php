...
@section('title','up-Notice Update')
@section('content') 
...
Up-Notice Update for front page </small>&nbsp;<a href="/upnotices">Notice View</a>
</h1>
</div><!-- /.page-header -->
<div class="row">
<div class="col-xs-12">
...
{{Form::open(['url'=>'/upnotices/'.$data->id ,'method'=>'PATCH','class'=>'form-horizontal','enctype'=>'multipart/form-data'])}}
